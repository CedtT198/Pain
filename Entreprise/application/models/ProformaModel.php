...
class ProformaModel extends CI_Model {
    ...
    //     $this->db->where('id_type_attestation', 5); // 1 est l'ID pour 'Bon de commande'
    ...
    public function getAll() {
        ...
        $this->db->where('id_type_attestation', 5);
    ...
    public function getById($id) {
        ...
        $this->db->where('id_type_attestation', 5); // Assurer que c'est un bon de commande
        $query = $this->db->get('attestation');
    ...
    public function getAllAttestation() {
        ...
        $this->db->where('a.id_type_attestation', 5); // 1 est l'ID pour 'Bon de commande'
        $query = $this->db->get();
