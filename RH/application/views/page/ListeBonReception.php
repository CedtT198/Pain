       ...
       <div class="col-md-12 grid-margin">
              <div class="row">
                     <div class="col-12 col-xl-8 mb-4 mb-xl-0">
                            <h3 class="font-weight-bold">BON DE RECEPTION</h3>
                            <h6 class="font-weight-normal mb-0">Liste de bon de réceptions</h6>
                     </div>
              </div>
       </div>
</div>
                                   ...
                                   <div class="col-12">
                                          <div class="table-responsive">
                                                 <table id="example" class="display expandable-table" style="width:100%">
                                                        ...
                                                        ?>
                                                               <tr class="odd">
                                                                      <td class="sorting_1"><?php echo $rec['id_attestation']; ?></td>
                                                                      <td><?php echo $rec['libelle'] ?></td>
                                                                      <td><?php echo $rec['date_attestation'] ?></td>
                                                                                                                              ...
                                                                                                                              <div class="col-md-12 grid-margin stretch-card">
                                                                                                                                     <div class="card">
                                                                                                                                            <div class="card-body">
                                                                                                                                                   ...
                                                                                                                                                   <p class="font-weight-bold">Date : <code><?php echo $rec['date_attestation']?></code></p>
                                                                                                                                                   <p class="font-weight-bold">Centre : <code><?php echo $this->CentreModel->getById($rec['id_centre'])['nom_centre']; ?></code></p>
                                                                                                                                                   <div class="row">
                                                                                                                                                                 ...
                                                                                                                                                                 <div class="card-body">
                                                                                                                                                                        <div class="table-responsive">
                                                                                                                                                                               <table class="table table-borderless">
                                                                                                                                                                                      ...
                                                                                                                                                                                      <?php
                                                                                                                                                                                      $total = 0;
                                                                                                                                                                                      $produits = $this->ProduitInAttestationModel->getProduitByAttestation($rec['id_attestation']);
